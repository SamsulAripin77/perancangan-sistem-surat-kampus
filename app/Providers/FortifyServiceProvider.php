...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Fortify::loginView(fn () => view('auth.login', [
            'namaUniversitas' => Setting::query()->where('key', 'nama_universitas')->value('value'),
        ]));

        // Autentikasi: cek kredensial + tolak user nonaktif dengan pesan khusus
        // (UX_SPEC 1.A.1 langkah 3). Kredensial salah → pesan generic (auth.failed),
        // tidak membocorkan field mana yang salah.
